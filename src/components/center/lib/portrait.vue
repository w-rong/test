<template>
    <div class="root" :style="{transform: `scale(${scale})`, transformOrigin: 'center bottom'}">
        <h3 class="svgh3">游客画像</h3>
        <div class="content">
...
export default {
    ...
    methods: {
        ...
        initChartPie () {
            ...
            axios.post('/tourist/findPortraitAttribute',  qs.stringify({queryTime: '2019-12', valueType: 'age'}))
                .then(data => {
        ...
        getIder () {
            ...
            let dentity = axios.post('/tourist/findPortraitIdentity',  qs.stringify({queryTime: '2019-12'}))
            let revisit = axios.post('/tourist/findPortraitRevisit',  qs.stringify({queryTime: '2019-12'}))
        ...
        getGender () {
            ...
            axios.post('/tourist/findPortraitAttribute',  qs.stringify({queryTime: '2019-12', valueType: 'gender'}))
                .then(data => {
                    console.log(data);
